...
VIDEO_FILE="/home/code-server/table_tennis_video/C0079.MP4"
SAVE_DIR="/home/code-server/table_tennis_video"
...
CUDA_VISIBLE_DEVICES=5 python predict.py --video_file "$VIDEO_FILE" --tracknet_file exp/TrackNet_best.pt --inpaintnet_file exp/InpaintNet_best.pt --save_dir "$SAVE_DIR" --large_video --output_video
