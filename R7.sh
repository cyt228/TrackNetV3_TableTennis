...
VIDEO_FILE="/home/wasn/table_tennis_video/02/C0167.MP4"
...
python speed_analysis/stroke_zone_analysis.py --save_video --video_file "$VIDEO_FILE" --ball_csv "$SAVE_DIR/${NAME}_ball.csv" --save_video --save_dir "$SAVE_DIR" --helper_table_json "$SAVE_DIR/${NAME}_helper_table.json"
