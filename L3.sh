...
VIDEO_FILE="/home/wasn/table_tennis_video/C0071.MP4"
...
python speed_analysis/stroke_zone_analysis.py --video_file "$VIDEO_FILE" --save_video --ball_csv "$SAVE_DIR/${NAME}_ball.csv" --save_dir "$SAVE_DIR" --helper_table_json "$SAVE_DIR/${NAME}_helper_table.json"
